...
import com.view.test.com.zhl.channeltagview.bean.ChannelItem;
import com.view.test.com.zhl.channeltagview.listener.OnChannelItemClicklistener;
import com.view.test.com.zhl.channeltagview.listener.UserActionListener;
import com.view.test.com.zhl.channeltagview.util.MeasureUtil;
        ...
        unAddedAdapter.setOnItemClickListener(new MultiItemTypeAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, RecyclerView.ViewHolder holder, int position) {
                ...
                if (showPahtAnim) {
                    ...
                    addedAdapter.notifyItemInserted(addedChannels.size() );
                }
                if (onChannelItemClicklistener != null) {
                    // 用户在这个回调处理自己的逻辑
